...
| Regiocode | In de context van UN/LOCODE (zie [Regio's: bedoeling en praktijk](../technical/regions-in-practice.md)): de *naam* van een regio, zoals `nl-ov-zwo`. Blijft op de node en gaat nooit de lucht in. Niet te verwarren met de transport code |
