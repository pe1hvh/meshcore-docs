...
[Route traceren](../../technical/route-tracing.md) voor hoe dat dan wél werkt.
...
gebrek; [Ontwerpbeslissingen](../logical/decisions.md) gaat in op de gevolgen
van die keuze.

> [!NOTE]
> Beide zijn in [Componenten](../logical/components.md) onder *Wat er niet is*
