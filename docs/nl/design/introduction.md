...
gaat — dat staat in [Techniek](../technical/layer-model.md) — maar hoe de
...
| Onderwerp | Staat in |
|---|---|
| Protocollagen en gedrag over de lucht | [Het Lagenmodel](../technical/layer-model.md) |
| Byte-indeling van pakketten | [Pakketstructuur](../technical/packet-structure.md) |
...
- [Rollen](logical/roles.md) — de zes applicaties die MeshCore kan zijn
- [Componenten](logical/components.md) — wat er is en waar het over gaat
- [Contracten](logical/interfaces.md) — de afspraken tussen componenten
- [Informatiemodel](logical/information-model.md) — de gegevens en hun relaties
- [Variabiliteit](logical/variability.md) — hoe één codebase 508 builds wordt
- [Ontwerpbeslissingen](logical/decisions.md) — de keuzes en hun gevolgen

**Technisch ontwerp**

- [De broncodestructuur](technical/source-layout.md) — wat waar staat, en de
  asymmetrie
- [Het klassenmodel](technical/class-model.md) — contract, implementatie,
  zelfstandig
- [Platformrealisatie](technical/platform-realisation.md) — vier families, één
  abstractie
- [Radiorealisatie](technical/radio-realisation.md) — waar de radiokeuze valt
- [Het buildsysteem](technical/build-system.md) — hoe 508 targets ontstaan
- [Compile-time configuratie](technical/configuration.md) — 277 macro's en hun
  eigenaar
- [Traceerbaarheid](technical/traceability.md) — logisch onderdeel naar
  bestand en regel
...
val is, staat in [Variabiliteit](logical/variability.md).
