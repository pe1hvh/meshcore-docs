...
Zie [Het frame](../technical/frame-format.md).
...
`CMD_RESET_PATH` (13). Zie [Route traceren](../../technical/route-tracing.md).
...
- [Verantwoordelijkheden](responsibilities.md) — waarom de driedeling zo
  loopt
- [Channel Structure & PSK](../../technical/channel-structure.md) — wat een
  kanaalsleutel doet
- [Regio's en Scopes](../../technical/regions-and-scopes.md) — de koppeling
  die de app bijhoudt
