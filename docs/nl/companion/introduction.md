...
| Wat er over de lucht gaat | [Het Lagenmodel](../technical/layer-model.md) |
| Structuur van de firmware zelf | [Ontwerp van MeshCore](../design/introduction.md) |
...
- **Logisch ontwerp**
  - [Verantwoordelijkheden](logical/responsibilities.md) — wie bewaart wat
  - [Het interactiemodel](logical/interaction-model.md) — vraag, antwoord,
    push en versieonderhandeling
  - [Informatiemodel](logical/information-model.md) — de gegevens die heen
    en weer gaan
- **Technisch ontwerp**
  - [De drie transporten](technical/transports.md) — wat het protocol van
    een verbinding eist
  - [Het frame](technical/frame-format.md) — wat er in de 176 bytes past
  - [De commandogroepen](technical/command-groups.md) — alle 58 commando's,
    geordend
  - [Architectuur van een client](technical/client-architecture.md) — de
...
- [Terminologie](../reference/terminology.md) — de begrippen uit deze sectie
