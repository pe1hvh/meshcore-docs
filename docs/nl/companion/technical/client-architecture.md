...
[Het interactiemodel](../logical/interaction-model.md) thuishoort:
...
het patroon uit
[Verantwoordelijkheden](../logical/responsibilities.md).
...
- [Het interactiemodel](../logical/interaction-model.md) — waarom
