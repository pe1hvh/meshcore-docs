...
komen uit [Regelgeving & Duty Cycle](../usage/regulations.md).
...
> [Regelgeving & Duty Cycle](../usage/regulations.md). De fork Dutch-MeshCore
> lost dit op met `set dutycycle auto`, dat de limiet uit de subband afleidt —
> zie [Forks & varianten](https://domca.nl/#analyse/forks-en-varianten).
