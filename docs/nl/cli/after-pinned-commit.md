...
> [`tools/cli-commands.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/cli-commands.py) en een tweede checkout.
...
gelden, zie [Regelgeving & Duty Cycle](../usage/regulations.md).
