...
[Regio's en Scopes](../technical/regions-and-scopes.md); de Nederlandse indeling
in [Regio's: bedoeling en praktijk](../technical/regions-in-practice.md).
...
**NL:** de basisconfiguratie uit [Aan de Slag](../usage/getting-started.md),
...
**NL:** de eigen provincie, zie [Aan de Slag](../usage/getting-started.md).
