...
|---|---|---|
| [Gebruik](usage/what-is-meshcore.md) | Wat MeshCore is, een node aan de praat krijgen, hardware, regelgeving, privacy | Geen programmeerkennis vereist |
| [Techniek](technical/layer-model.md) | Protocol, pakketopbouw byte voor byte, encryptie, routing, repeaters, room server | Basisbegrip van netwerken en hexadecimale notatie helpt; programmeren niet nodig |
| [Platform](platform/platforms.md) | De vier platformfamilies, de keuze ertussen en de pinbezetting per variant | Geen, afgezien van globale kennis van microcontrollers |
...
| [Ontwerp Node → logisch](design/logical/roles.md) | Rollen, componenten, contracten, informatiemodel, variabiliteit, ontwerpbeslissingen | Basiskennis van klassen en interfaces aanbevolen; de tekst blijft weg bij broncode |
| [Ontwerp Node → technisch](design/technical/source-layout.md) | Broncodestructuur, klassenmodel, platform- en radiorealisatie, buildsysteem, macro's, traceerbaarheid | C++ klassen, overerving en PlatformIO-buildconfiguraties |
| [Ontwerp Companion → logisch](companion/logical/responsibilities.md) | Wie bewaart wat, vraag-antwoord en push, versieonderhandeling, informatiemodel | Basisbegrip van verkeer tussen twee systemen; enkele C++ fragmenten |
| [Ontwerp Companion → technisch](companion/technical/transports.md) | De drie transporten, het frameformaat, alle achtenvijftig commando's, de lagen van een client | Programmeerervaring; kennis van binaire protocollen helpt |
...
| [Naslag](reference/terminology.md) | Terminologie, referenties, links | Geen. Bedoeld om in op te zoeken, niet om door te lezen |
...
- **Narekenbaar.** De voorbeelden in
  [Regio's en Scopes](technical/regions-and-scopes.md) zijn met
  [`tools/example-calculation.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/example-calculation.py) te
