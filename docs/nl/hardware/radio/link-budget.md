...
> opnieuw uitgerekend door [`tools/link-budget.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/link-budget.py).
...
> [Aan de Slag](../../usage/getting-started.md). De som verderop op deze
...
- [`tools/link-budget.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/link-budget.py) — rekent elk cijfer
...
- [Regelgeving & Duty Cycle](../../usage/regulations.md) — hoeveel van dit
