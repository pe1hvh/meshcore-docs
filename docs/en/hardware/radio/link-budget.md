...
> recomputed by [`tools/link-budget.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/link-budget.py).
...
- [`tools/link-budget.py`](https://github.com/pe1hvh/meshcore-docs/blob/main/tools/link-budget.py) — recomputes every
  figure on this page
