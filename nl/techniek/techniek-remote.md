...
>
> - **CLI over de mesh** — een versleuteld tekstbericht met `txt_type` = CLI-commando (zie [MeshCore Packet Structuur](techniek-packets.md)). Een ingelogde admin stuurt zo elk CLI-commando naar een node op afstand.
