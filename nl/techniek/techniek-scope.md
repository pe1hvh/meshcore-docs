...
[Aan de Slag](../gebruik/aan-de-slag.md). Voor de naamgevingsafspraken binnen
...
[Regio's: bedoeling en praktijk](techniek-regios-praktijk.md).
...
> [MeshCore Packet Structuur](techniek-packets.md).
...
[het kanaalbericht verderop](techniek-packets.md).
...
hulpmiddelen — zie [Aan de Slag](../gebruik/aan-de-slag.md).
