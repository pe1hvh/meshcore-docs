...
![Het volledige LoRa-frame, met daarbinnen het MeshCore-frame uitgeklapt](../../images/nl/packet-structure-1.svg)
...
| `transport_codes` | 4 (optioneel) | Twee 16-bits codes; alléén bij de twee TRANSPORT-routetypes. Hier zit de transport code (de **scope**) — zie [Regio's en Scopes](regions-and-scopes.md) | MeshCore |
...
![De header-byte opgesplitst in bitgroepen, met het route type uitgelicht](../../images/nl/packet-structure-2.svg)
...
[Private & Public Key Encryptie](key-encryption.md) en
[Route traceren](route-tracing.md) wordt beschreven.
...
![Byte-voor-byte opbouw van een kanaalbericht, met de transport code uitgelicht](../../images/nl/packet-structure-3.svg)
...
[Regio's en Scopes](regions-and-scopes.md) behandelt hoe die code wordt berekend,
